...
import 'package:result_management_system/Dashboard/other/Course_detail.dart';
import 'package:result_management_system/Dashboard/student/Current_Sem_Result.dart';
import 'package:result_management_system/Dashboard/student/Previous_Sem_Result.dart';
import 'package:result_management_system/Dashboard/other/ResetpassWord.dart';
import 'package:result_management_system/set_up/login.dart';
import 'package:result_management_system/Dashboard/other/result_profile.dart';
import 'package:result_management_system/Profile/profile.dart';
import 'package:result_management_system/Auth.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
//import 'Contact.dart';
import 'package:result_management_system/Dashboard/other/Contact.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context){
              ...
              child: Card(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Image.asset("images/notepad.png",height: 70 ,width:40,color: Colors.pinkAccent,),
                    Text('Current Result', style: TextStyle(fontSize: 22,),),
    ...
    GestureDetector(
               onTap: () {setState(() {Navigator.push(context, MaterialPageRoute(builder: (context) => Course()),);});},
          child: Card(
            shape: RoundedRectangleBorder(
              borderRadius:  BorderRadius.circular(15),
            ),
          ...
          GestureDetector(
            onTap: () {setState(() {Navigator.push(context, MaterialPageRoute(builder: (context) => ContactScreen()),);});},
            child: Card(
              shape: RoundedRectangleBorder(
                borderRadius:  BorderRadius.circular(15),
              ),
