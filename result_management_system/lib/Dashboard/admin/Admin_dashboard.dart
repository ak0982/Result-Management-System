...
import 'package:result_management_system/Dashboard/admin/admin_student.dart';
...
import 'package:result_management_system/password%20generator/generate_password.dart';
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    setState(() {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Admin_Student()),
                      );
                    });
                  },
                ...
                GestureDetector(
                  ...
                  child: Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        Image.asset("images/key.png",height: 70 ,width:40,color: Colors.pinkAccent),
